package com.yunyang.muke.controller;
...
import com.yunyang.muke.enums.OperatorFriendRequestTypeEnum;
import com.yunyang.muke.enums.SearchFriendsStatusEnum;
import com.yunyang.muke.pojo.Users;
import com.yunyang.muke.pojo.bo.UsersBO;
import com.yunyang.muke.pojo.vo.MyFriendsVO;
import com.yunyang.muke.pojo.vo.UsersVO;
...
import com.yunyang.muke.utils.IMoocJSONResult;
import com.yunyang.muke.utils.MD5Utils;
...
//		"dhawuidhwaiuh3u89u98432_80x80.png"
	...
	public IMoocJSONResult getUnReadMsgList(String acceptUserId) {
		...
		// 查询列表
		List<com.yunyang.muke.pojo.ChatMsg> unreadMsgList = userService.getUnReadMsgList(acceptUserId);
